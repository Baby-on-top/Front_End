...
import { boardDelete } from '../../utils/apis';
...
export default function DeleteModal({ id }) {
    ...
    const deleteBoard = async (data) => {
        setBoardList(boardList.filter(boardList => boardList.boardId !== boardId));
    ...
    return (
        <>
            {modal && (
                ...
                <div onClick={toggleModal} className="overlay" css={{
                    width: '100vw',
                    height: '100vh',
                    top: 0,
                    left: 0,
                ...
                <div className="modal-content" css={{
                    ...
                    <div className="modal-top">
                        ...
                        <button className="modal-save-after" type="submit" onClick={async () => {
                            const deleteData = await deleteInfo()
                            toggleModal()
                            await deleteBoard(deleteData)
                        }} css={{
                            height: '40px',
                            width: '100px',
                            marginTop: '25px',
